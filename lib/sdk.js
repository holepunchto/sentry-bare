...
const { onUncaughtExceptionIntegration } = require('./integrations/on-uncaught-exception')
const { onUnhandledRejectionIntegration } = require('./integrations/on-unhandled-rejection')
...
const getDefaultIntegrations = (exports.getDefaultIntegrations = function getDefaultIntegrations() {
  return [contextIntegration(), onUncaughtExceptionIntegration(), onUnhandledRejectionIntegration()]
})
